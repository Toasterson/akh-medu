...
Phases 1-15b + 25a-25e are complete. Detailed completion checklists live under `docs/ai/phases/`.
...
- **15a-15b**: Causal World Model + Event Calculus — [phase](docs/ai/phases/phase-15-causal.md), [plan](docs/ai/plans/2026-02-22-phase15-causal-world-model.md), [ADR 032](docs/ai/decisions/032-event-calculus-engine.md)
...
- **15c-15d**: Counterfactuals, temporal experience — [plan](docs/ai/plans/2026-02-22-phase15-causal-world-model.md)
