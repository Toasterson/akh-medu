...
- **32**: LLM Knowledge Extraction (LLM as knowledge oracle for bootstrap, multi-pass elicitation, hallucination detection, confidence assignment) — [plan](docs/ai/plans/2026-03-26-phase32-llm-knowledge-extraction.md), [ADR 042](docs/ai/decisions/042-llm-knowledge-extraction.md)
- **33**: Grounded Verbalization (grammar aggregation rules, T5/mT5 data-to-text NLG, NeuroLogic constrained decoding, Qwen→on-demand migration) — [plan](docs/ai/plans/2026-03-26-phase33-grounded-verbalization.md), [ADR 043](docs/ai/decisions/043-grounded-verbalization.md)
